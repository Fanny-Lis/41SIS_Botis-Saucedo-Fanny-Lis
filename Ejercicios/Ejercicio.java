...
public class Ejercicio {
    /**
     Vamos a hacer una calculadora, un conversor de unidades creación de cuadros y
      de movimiento
     */

    // los metodos son las operaciones de un objeto o de una clase, tambien llamados comportamientos
     //
    ...
    public void Ejercicio1() {
        ...
        switch (operacion) {
            ...
            case 'b':
            do {
                System.out.println("Para detener multiplicación ingrese el numero 0");
                System.out.println("Escriba los numeros que desee sumar o restar");
                num1 = entrada.nextDouble();
                multi *= num1;
                // multi = multi * num1;
    ...
    public void Ejercicio2() {
        //vamos a crear un programa que se encarge de convertir kilogramos a libras y de metros/segundo  //
        // Hacer de tarea de m a yarda y millas//
