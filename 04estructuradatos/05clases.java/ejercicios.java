...
class Ejercicios {
    ...
    public void Ejercicio1(){
        ...
        switch(operacion){
            ...
            case 'b':
            do{
                System.out.println("Para detener la multiplicación ingrese el numero 0");
    ...
    public void Ejercicio2(){
        /*  vamos a crear un programa que se encargue de convertir kg a Libras y gramos a m/s a km/s
        tarea m a yardas y millas*/
        double metros = 0.00, kg = 0.00, velocidad = 0.00, cm = 100.00,
        pulgadas = 2.54, gramos = 1000.00, libra = 2.20, ms = 0.00;
        double a, b;
        System.out.println("Selecciones la cantidad que desea convertir de acuerdo a las siguientes unidades :");
        System.out.println("a.Metros a cm y pulgadas");
        System.out.println("b.Kg a libras y gramos");
        System.out.println("c.m/s a k/h");
        System.out.println("d.tarea");
        op = entrada.next().charAt (index: 0);
        switch(op){
            case 'a':
            System.out.println("Ingrese los metros atransformar:");
        a = metros * cm;
        b = metros * pulgada;
        System.out.println("La cantidad en metros es: " + metros + "de m a cm son :" +a + "de metros a pulgadas son:" +b);
    }
            break;
            case 'b':
            System.out.println("Ingrese los kg atransformar:");
            a = kg * gramos;
            b = kg * libra;
