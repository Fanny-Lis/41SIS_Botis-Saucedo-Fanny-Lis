...
public class Logueo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String usu = usuario.getText(), con=contraseña.getText();
        if(usu.equals("Fanny Lis") && con.equals("pizza")){
            Registro r=new Registro();
            JOptionPane.showMessageDialog(null,"Bienvenida :D "+usu);
            r.show();
        }else{
            JOptionPane.showMessageDialog(null,"No tienes un usuario xC");
